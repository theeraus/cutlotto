...
<body topmargin="0"  leftmargin="0" onLoad="doPrint();">
	...
	<center><br>
			<table  border="0"  cellpadding="0" cellspacing="0"  width="100%">
				...
				<%
				SQL="select  * from sc_user where user_type='P' and create_by=" & dealer_id & " order by case when isnumeric(login_id)=1 then convert(int,login_id) else login_id end "
				'SQL="select  * from sc_user where user_type='P' and create_by=" & dealer_id & " order by login_id "
