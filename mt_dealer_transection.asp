...
<HTML>
<HEAD>
<TITLE>รายการธุระกรรมดีลเลอร์</TITLE>
...
<div class="kt-portlet__body">
    <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
        ...
        <tbody>
        <%  
            sql = "select u.user_name,u.user_id, py.tran_type, py.before_money, py.transfer_money,py.current_money,py.note, CONVERT(VARCHAR(30), created_date, 120) as created_date " _
