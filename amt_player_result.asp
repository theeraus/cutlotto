...
<%
		...
		'------- เช็ครหัสดูยอดเงินว่าถูกต้องหรือไม่ ------------------- ยกเลิก 2009-07-25
		'Dim sum_password
		...
		'------- เช็ครหัสดูยอดเงินว่าถูกต้องหรือไม่ -------------------
		'------- เช็คว่ามีการออกเลขหรือยัง -----------------------------------
	...
	<table width="500"  border="0" cellspacing="1" cellpadding="1" bgcolor="#606060">
		<tr height="40">
			<td class="tdbody1" align="center" bgcolor="#FFFFA4">
				<font color="red">เลขยังไม่ออก ไม่สามารถดูได้</font> <br>
			</td>
		</tr>
	</table>
	</center>
...
<body topmargin="0"  leftmargin="0">
	...
	<table width="500"  border="0" cellspacing="1" cellpadding="1" bgcolor="#606060">
		<tr height="40">
			<td class="tdbody1" align="center" bgcolor="#FFFFA4">
				<font color="red">รหัสดูยอดเงินไม่ถูกต้อง</font> <br>
				<a href="amt_player.asp">กลับไปกรอกรหัสดูยอดเงินใหม่ คลิ๊กที่นี่</a>
			</td>
		</tr>
	</table>
	</center>
