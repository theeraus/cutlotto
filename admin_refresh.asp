					...
					<td align="center" colspan=2>
						<table  border="0"  cellpadding="1" cellspacing="1" bgcolor="#000040" width="100%">
							<tr>
								...
								<td class="textbig_white" align="center" bgcolor="#282828"><input type=button onClick="return ClearUsage();" value="ล้างจำนวนครั้งสะสม" class="btn btn-danger btn-sm"></td>
							</tr>
							...
							while not objRS.eof
								...
								if mode="edit" and Cint(objRS("user_id"))=Cint(edit_user_id) then
									...
									<tr>
										<td bgcolor="#FFFFFF">
											<input type=button value="บันทึก" class="btn btn-primary btn-sm" style="cursor:hand; width: 75px;" onClick="click_edit_save('<%=objRs("user_id")%>');" >
											<input type=button value="ยกเลิก" class="btn btn-danger btn-sm" style="cursor:hand; width: 75px;" onClick="click_cancel();" >
										</td>
										...
										<td class="tdbody" bgcolor="<%=c %>" align="left">
											&nbsp;<input type=button value="กับทั้งหมด" class="btn btn-primary btn-sm" onClick="click_edit_all('<%=objRS("user_id")%>','<%=objRS("refresh_time")%>');">&nbsp;
											&nbsp;<input type=button value="กับเอเย่นต์" class="btn btn-primary btn-sm" onClick="click_edit_player('<%=objRS("user_id")%>','<%=objRS("refresh_time")%>');" >&nbsp;
										</td>
									...
									<tr>
										<td bgcolor="#FFFFFF">
											<input type=button value="แก้ไข" class="btn btn-primary btn-sm" style="cursor:hand; width: 75px;" onClick="click_edit('<%=objRs("user_id")%>');" >
										</td>
								...
								If   CStr(objRS("user_id")) = CStr(view_dealer_id) Then
									...
									while not objPY.eof
										...
										if mode="edit" and Cint(objPY("user_id"))=Cint(edit_user_id) then
											...
											<tr>
												<td bgcolor="#FFFFFF">
													<input type=button value="บันทึก" class="btn btn-primary btn-sm" style="cursor:hand; width: 75px;" onClick="click_edit_save('<%=objPY("user_id")%>');" >
													<input type=button value="ยกเลิก" class="btn btn-danger btn-sm" style="cursor:hand; width: 75px;" onClick="click_cancel();" >
												...
												<td class="tdbody" bgcolor="<%=c %>" align="left">
													&nbsp;<input type=button value="กับทั้งหมด" class="btn btn-primary btn-sm" onClick="click_edit_all('<%=objPY("user_id")%>','<%=objPY("refresh_time")%>');">&nbsp;
												</td>
												<td class="tdbody" bgcolor="<%=c %>" align="left"></td>
												<td class="tdbody" bgcolor="<%=c %>" align="left"></td>
												<td class="tdbody" bgcolor="<%=c %>" align="left"></td>
											...
											<tr>
												<td bgcolor="#FFFFFF">
													<input type=button value="แก้ไข" class="btn btn-primary btn-sm" style="cursor:hand; width: 75px;" onClick="click_edit('<%=objPY("user_id")%>');" >
												</td>
