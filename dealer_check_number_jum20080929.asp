...
%>	
		...
		<table align=center><tr><td align=center colspan=3><input type=button value='  พิมพ์  ' onClick="print_summoney();">&nbsp;&nbsp;<input type=button value='  ใบสรุปยอดเก็บ  ' onClick="print_sumkeep();"></td></tr></table>
	<br><br>
