		...
		<tr valign="top">
			<td align="left">
				<table  border="0"  cellpadding="1" cellspacing="0"><!----  table top Level 2 ทางซ้าย  ---->	
					<tr>
						<td align="right">
							<table width="100%" border=0 cellpadding="1" cellspacing="0" >
								...
								<tr>	
									<td class="tdbody" align="right" colspan="18"><b><font color="#CE243E">F7=ขณะนี้ใบที่ 
					...
					<tr>
						<td align="right">
<input type="button" class="inputR" value="F10=ส่ง" style="cursor:hand; width: 75px;" onClick="clicksubmit()"></td>
					</tr>
					<tr>
						<td align="right"><a href="key.html" target="_blank"><input type="button" class="inputE" value="วิธีกดแทงโพย" style="cursor:hand; width: 100px;"></a></td>
					</tr>
					<tr height="20">
					...
					<tr>
						<td align="right">
							<input type="button" class="inputM" value="ขอเครดิตเพิ่มแล้วกด" style="cursor:hand;width: 170px;"
