...
<!--group_type // DB:msg_type  =  2  = ��ͤ��� Dealer-->
	...
	<center><br>
    <strong class="tdbody">	&bull;  #  �駢�������١��� #  &bull;</strong>
	...
	<tr>
            ...
            <tr>
                    ...
                    <td class="textbig_white" align="center" bgcolor="#000066">����ʴ���</td>
			</tr>
