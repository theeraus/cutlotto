...
'	sub ExcuteCommand(Byval strSql) 
	...
	LenPw = len(Request("password1"))
		...
		'��������ҧ��� ��� �繤�ᷧ
		'¡��ԡ jum 2009-02-19
		if buser <> "" and bdealer <> "" and bpass <> "" then '��ᷧ
...
'showstr "d " & rs("user_disable")
	...
	if chkOk =true then
		...
		call showmessage(strMsg&"&nbsp;&nbsp;[<a href='index.asp?page=signin.asp'>��͹��Ѻ</a>]")
		Response.end		
	end if	
