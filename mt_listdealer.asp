...
<body topmargin="0"  leftmargin="0" onload="setInterval('blinkIt()',500)">
	<form name="form1" action="mt_listdealer.asp" method="post">
	<center><br>
			...
			<table  border="0"  cellpadding="1" cellspacing="1"  width="100%" class="table">
				<tr>
					<td width="50%" style="text-align: center;">
						...
						<input type="button" class="btn btn-primary btn-sm" value="พิมพ์" style="cursor:hand; width: 75px;" onClick="window.print();">
				...
				<tr>
					<td align="center">
						<table  border="0"  cellpadding="1" cellspacing="1" width="80%">							
							<tr>
								<td class="head_red">
									กดที่หมายเลขเจ้ามือเพื่อดูเอเย่นต์
								</td>
								<td align="right">
				...
				<tr>
					<td align="center" colspan=2>
						<table  border="0"  cellpadding="1" cellspacing="1" bgcolor="#000040">					
							<tr>
								<td class="textbig_white" align="right" colspan="4" bgcolor="#282828">หมายเลข</td>
								...
								-->
								<td class="textbig_white" align="center" bgcolor="#282828" >ยอดรับแทง </td>	
								<td class="textbig_white" align="center" bgcolor="#282828" >ใช้จริง </td>	
								<td class="textbig_white" align="center" bgcolor="#282828" colspan=2>จำนวนผู้ใช้</td>						
								<td class="textbig_white" align="center" bgcolor="#282828">บันทึก โทร ที่อยู่ หมายเหตุ ฯลฯ</td>
								<td class="textbig_white" align="center" bgcolor="#282828">ตั้งค่าสู้บน</td>
							</tr>
							
							<%
							'SQL="select  * from sc_user where user_type='D' order by user_id "
							SQL="exec spGetDealer_byAdmin"
							set objRS=objDB.Execute(SQL)
							Dim c
							c="#FFFFA4"
							...
							%>
								<tr>
									...
									<td class="tdbody" bgcolor="<%=c %>" align="left">
<!-- 										<input type="text" name="cntlogin" 
										class="input1"  size="3" maxlength="20">												 -->
										&nbsp;
									</td>
							...
							while not objRS.eof
								...
								if mode="edit" and Cint(objRS("user_id"))=Cint(edit_user_id) then
									...
									<tr>
										...
										<td bgcolor="#FFFFFF">
											<input type="button" class="btn btn-danger btn-sm" value="ยกเลิก" style="cursor:hand; width: 75px;" onClick="click_del('<%=objRs("user_id")%>', '<%=objRs("user_name")%>');" >
										</td>											
										...
										<!--
										<td class="tdbody" bgcolor="<%=c %>" align="left" width="80"><%=objRS("sum_password")%>	</td>
										-->
										<td class="tdbody" bgcolor="<%=c %>" align="right"><%=objRS("limit_play")%></td>
										<td class="tdbody" bgcolor="<%=c %>" align="right" style="cursor:hand;" onclick="click_play_amt('<%=objRs("user_id")%>');"><%=objRS("play_amt")%></td>
										<td class="tdbody" bgcolor="<%=c %>" align="center" width="80"><%=objRS("cnt_login")%>	</td>
										<td class="tdbody" bgcolor="<%=c %>" align="right" width="80">
											<%=objRS("ip_address")%>
										</td>																			
										<td class="tdbody" bgcolor="<%=c %>" align="left"><%=objRS("address_1")%></td>
										<td class="tdbody" bgcolor="<%=c %>" align="center"><INPUT TYPE="button" class="btn btn-primary btn-sm" value="ตั้งค่า" onClick="open_setvalue('<%=objRs("user_id")%>');" style="width:50"></td>
									</tr>
									<tr>										
										<td bgcolor="#FFFFFF" colspan="13" align="center">
