			...
			<table  border="0"  cellpadding="1" cellspacing="1"  width="100%">
				<tr>
					<td width="50%">
						...
						<input type="button" class="inputP" value="พิมพ์" style="cursor:hand; width: 75px;" onClick="window.print();">
							...
							while not objRS.eof
								...
								if mode="edit" and Cint(objRS("user_id"))=Cint(edit_user_id) then
									...
									<tr>
										...
										<td bgcolor="#FFFFFF">
											<input type="button" class="inputR" value="ยกเลิก" style="cursor:hand; width: 75px;" onClick="click_del('<%=objRs("user_id")%>', '<%=objRs("user_name")%>');" >
										</td>											
										...
										<td class="tdbody" bgcolor="<%=c %>" align="center"><INPUT TYPE="button" class=inputM value="ตั้งค่า" onClick="open_setvalue('<%=objRs("user_id")%>');" style="width:50"></td>
									</tr>
									<tr>										
