...
<%
		...
		create_by_player=Request("create_by_player")
%>
<html>
<head>
...
<body topmargin="0" leftmargin="0" scroll = no  style="border : solid #606060; border-width : 1px;">
	<form name="form1" action="search_player_level2.asp" method="post">
		...
		<tr>
			<td align="center" >			
				...
				<table width="95%"  border="0" cellspacing="1" cellpadding="1" bgcolor="#606060">
					...
					<input type="hidden" name="create_by_player" value="<%=create_by_player%>">
...
SQL="exec spGetPlayerPriceName2 " & dealer_id & "," & game_type & ",'" & chr_search & "'," & create_by_player
'response.write SQL
						end if						
