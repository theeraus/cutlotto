...
Dim player_id, ticket_number, game_id , rec_status, ticket_id, send_status, key_from, key_id
	...
	if Request("act")="save" then
		...
		rec_status=mlnStatusSend ' ��
		send_status=mlnSendOtherDealer  ' 
		key_from=mlnKeyCom       ' ᷧ�ҡ com 
		...
		do while not objRec.eof
			...
			key_seq=i
			number_status=mlnNumStatusSend    '  ��
...
'showstr strsql
	...
	if chkOk =true then
		...
		call showmessage(strMsg&"&nbsp;&nbsp;[<a href='index.asp?page=dealer_tudroum_send.asp'>��͹��Ѻ</a>]")
		Response.end		
	end if	
