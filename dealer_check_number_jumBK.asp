...
<BODY topmargin=0 leftmargin=0 onLoad="document.form1.txt3up.focus();">
	...
	<TABLE  align=center class=table_blue>        	
		...
		<tr align=center bgColor=#66CCFF  class=head_blue>
			...
			<td><input type=button onClick="document.all.form1.chk1.value='ตรวจเลข'; document.all.form1.submit();" name="chk" value="ตรวจเลข"></td>
		</tr>
	</table>
	</FORM>
	<br><br>
...
'เลขแทงออก
			...
			'	& "GROUP BY tb_ticket_number.play_type " _
			'	& "Having play_type = "&cint(recNumType("ref_code"))
'	เปลี่ยนวิธีการดึง แทงออก เพราะว่าราคาลด จ่าย ต้องคิดจากราคากลาง
...
%>	
		...
		<table align=center><tr><td align=center colspan=3><input type=button value='  พิมพ์  ' onClick="print_summoney();"></td></tr></table>
	<br><br>
